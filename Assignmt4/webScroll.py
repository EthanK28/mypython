...
'''
url = ("cse.koreatech.ac.kr", "koreatech.ac.kr")
input_url = "cse.koreatech.ac.kr"


url_dict = webScroll(input_url)
f = open(url[0]+".words.frequency", 'w+')

pickle.dump(url_dict, f)
f.close()
f = open(url[0]+"words.frequency")
x = pickle.load(f)
list = []
